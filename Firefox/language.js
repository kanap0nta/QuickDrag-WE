...
const TRANSLATIONS = Object.freeze({
  en: {
    ...
    rule_invalid_error: "Invalid regular expression",
    save_btn: "Save",
    save_btn_done: "Saved",
  },
  "zh-CN": {
  ...
  de: {
    ...
    rule_invalid_error: "Ungültiger regulärer Ausdruck",
    save_btn: "Speichern",
  ...
  "ko-kr": {
    ...
    rule_invalid_error: "유효하지 않은 정규 표현식",
    save_btn: "저장",
  ...
  "ru-RU": {
    ...
    rule_invalid_error: "Недопустимое регулярное выражение",
    save_btn: "Сохранить",
  ...
  fr: {
    ...
    rule_invalid_error: "Expression régulière invalide",
  ...
  "it-IT": {
    ...
    rule_invalid_error: "Espressione regolare non valida",
    save_btn: "Salva",
  ...
  cs: {
    ...
    rule_invalid_error: "Neplatný regulární výraz",
    save_btn: "Uložit",
  ...
  da: {
    ...
    rule_invalid_error: "Ugyldig regulært udtryk",
    save_btn: "Gem",
    save_btn_done: "Gemt",
  },
  nl: {
    ...
    rule_invalid_error: "Ongeldige reguliere expressie",
    save_btn: "Opslaan",
  ...
  pl: {
    ...
    rule_invalid_error: "Nieprawidłowe wyrażenie regularne",
    save_btn: "Zapisz",
  ...
  "pt-BR": {
    ...
    rule_invalid_error: "Expressão regular inválida",
    save_btn: "Salvar",
    save_btn_done: "Salvo",
  },
  sr: {
    ...
    rule_invalid_error: "Неважећи регуларни израз",
    save_btn: "Сачувај",
  ...
  "sv-SE": {
    ...
    rule_invalid_error: "Ogiltigt reguljärt uttryck",
    save_btn: "Spara",
  ...
  "tr-TR": {
    ...
    rule_invalid_error: "Geçersiz düzenli ifade",
    save_btn: "Kaydet",
  ...
  uk: {
    ...
    rule_invalid_error: "Недійсний регулярний вираз",
    save_btn: "Зберегти",
  ...
  "vi-vn": {
    ...
    rule_invalid_error: "Biểu thức chính quy không hợp lệ",
    save_btn: "Lưu",
