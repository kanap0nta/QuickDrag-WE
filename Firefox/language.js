...
const TRANSLATIONS = Object.freeze({
  ...
  de: {
    ...
    reload_notice: "Seite neu laden, um Änderungen anzuwenden",
  ...
  "ko-kr": {
    ...
    reload_notice: "변경 사항을 적용하려면 페이지를 다시 로드하세요",
    reload_button: "다시 로드",
  ...
  "ru-RU": {
    ...
    reload_notice: "Перезагрузите страницу, чтобы применить изменения",
  ...
  fr: {
    ...
    reload_notice: "Rechargez la page pour appliquer les modifications",
  ...
  "it-IT": {
    ...
    reload_notice: "Ricarica la pagina per applicare le modifiche",
  ...
  cs: {
    ...
    reload_notice: "Obnovte stránku, aby se změny projevily",
    reload_button: "Obnovit",
  ...
  da: {
    ...
    reload_notice: "Genindlæs siden for at anvende ændringer",
  ...
  nl: {
    ...
    reload_notice: "Herlaad de pagina om wijzigingen toe te passen",
  ...
  pl: {
    ...
    reload_notice: "Odśwież stronę, aby zastosować zmiany",
  ...
  "pt-BR": {
    ...
    reload_notice: "Recarregue a página para aplicar as alterações",
  ...
  sr: {
    ...
    reload_notice: "Поново учитајте страницу да бисте применили измене",
    reload_button: "Поново учитај",
  ...
  "sv-SE": {
    ...
    reload_notice: "Ladda om sidan för att tillämpa ändringar",
  ...
  "tr-TR": {
    ...
    reload_notice: "Değişiklikleri uygulamak için sayfayı yenile",
    reload_button: "Yenile",
  ...
  uk: {
    ...
    reload_notice: "Перезавантажте сторінку, щоб застосувати зміни",
  ...
  "vi-vn": {
    ...
    reload_notice: "Tải lại trang để áp dụng các thay đổi",
