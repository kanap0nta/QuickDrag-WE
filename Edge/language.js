...
*/
	"en":{ // 英語
		...
		is_prefer_save_image	:" In the case of an image with a link, priority is given to image storage",
	...
	"ru-RU":{ // ロシア語 (ロシア)
		...
		is_prefer_save_image	:" В случае изображения со ссылкой приоритет отдается хранилищу изображений",
	...
	"uk":{ // ウクライナ語
		...
		is_prefer_save_image	:" У випадку з зображенням із посиланням пріоритет приділяється зберіганню зображень",
